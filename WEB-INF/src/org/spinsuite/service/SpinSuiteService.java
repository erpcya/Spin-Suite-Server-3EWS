...
*  	<li>FR [ 9223372036854775807 ] Add Default Web-Services for Initial Load Mobile
*  	@see https://adempiere.atlassian.net/browse/ADEMPIERE-403
**/

public interface SpinSuiteService {
	
	/** Initial Load Web Service*/
	public ILResponseDocument InitialLoad(ILCallDocument req) throws XFireFault;
	/** Show Version Web Service*/
	public String getVersion();
	/** Authenticate Web Service*/
	public boolean Authenticate(ILAuthenticateDocument authenticate) throws XFireFault;
}
